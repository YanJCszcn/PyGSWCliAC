...
def pce_pinit(idx: 'int', enb: 'int') -> "void":
    return _PySwitchCli.pce_pinit(idx, enb)
pce_pinit = _PySwitchCli.pce_pinit

def pce_portId(enb: 'int', p: 'int') -> "void":
    return _PySwitchCli.pce_portId(enb, p)
pce_portId = _PySwitchCli.pce_portId

def pce_act_forwarding(act: 'int', portmap: 'int') -> "void":
    return _PySwitchCli.pce_act_forwarding(act, portmap)
pce_act_forwarding = _PySwitchCli.pce_act_forwarding

def pyGSW_PceRuleWrite() -> "int":
    return _PySwitchCli.pyGSW_PceRuleWrite()
pyGSW_PceRuleWrite = _PySwitchCli.pyGSW_PceRuleWrite

def pyGSW_PceRuleRead() -> "int":
    return _PySwitchCli.pyGSW_PceRuleRead()
pyGSW_PceRuleRead = _PySwitchCli.pyGSW_PceRuleRead

def pyGSW_PceRuleReadf(idx: 'int', enb: 'int') -> "int":
    return _PySwitchCli.pyGSW_PceRuleReadf(idx, enb)
pyGSW_PceRuleReadf = _PySwitchCli.pyGSW_PceRuleReadf
